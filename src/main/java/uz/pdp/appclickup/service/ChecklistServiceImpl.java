...
public class ChecklistServiceImpl implements ChecklistService {
    ...
    public ApiResponse addOrEditChecklistItem(CheckListItemDTO checkListItemDTO, Long wId, User user) {
        ...
        Icon.CheckListItem checkListItem = null;
        ...
        if (checkListItemDTO.getId() == null) {
            checkListItem = new Icon.CheckListItem(
            ...
            Optional<Icon.CheckListItem> optionalCheckListItem = checkListItemRepository.findById(checkListItemDTO.getId());
